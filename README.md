...
Similarly, enclosing text in a double asterisk such as `**text2**` **bolds** it, making it display as **text2**. This line in general syntax would be written as `{bold=true}text2{bold=false}`.
